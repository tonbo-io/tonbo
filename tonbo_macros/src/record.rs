...
fn trait_record_codegen(
    ...
    quote! {
        impl ::tonbo::record::Record for #struct_name {
            ...
            fn key(&self) -> <Self::Key as ::tonbo::record::Key>::Ref<'_> {
                #fn_primary_key
            }
...
fn trait_decode_ref_codegen(
    ...
    quote! {
        impl<'r> ::tonbo::record::RecordRef<'r> for #struct_ref_type {
            ...
            fn key(self) -> <<<#struct_ref_type as ::tonbo::record::RecordRef<'r>>::Record as ::tonbo::record::Record>::Key as ::tonbo::record::Key>::Ref<'r> {
...
fn struct_builder_codegen(
    ...
    quote! {
        ...
        impl ::tonbo::inmem::immutable::Builder<#struct_arrays_name> for #struct_builder_name {
            fn push(&mut self, key: ::tonbo::timestamp::Ts<<<#struct_name as ::tonbo::record::Record>::Key as ::tonbo::record::Key>::Ref<'_>>, row: Option<#struct_ref_name>) {
