...
use crate::{path_to_type,  DataType};
use crate::keys::PrimaryKey;
use crate::schema_model::ModelAttributes;
...
pub(crate) fn handle(ast: DeriveInput) -> Result<proc_macro2::TokenStream, Error> {
    ...
    let record_codegen = trait_record_codegen(&struct_name, primary_key, &to_ref_init_fields, &schema_fields, &size_fields);
...
fn trait_record_codegen(struct_name: &Ident, primary_key: PrimaryKey,
                        to_ref_init_fields: &Vec<proc_macro2::TokenStream>, schema_fields: &Vec<proc_macro2::TokenStream>, size_fields: &Vec<proc_macro2::TokenStream>) -> proc_macro2::TokenStream {
    let struct_arrays_name = Ident::new(
        &format!("{}ImmutableArrays", struct_name),
        struct_name.span(),
    );
...
fn trait_decode_codegen() -> proc_macro2::TokenStream {
    todo!()
}

fn struct_ref_codegen() -> proc_macro2::TokenStream {
    todo!()
}

fn trait_decode_ref_codegen() -> proc_macro2::TokenStream {
    todo!()
}

fn trait_encode_codegen() -> proc_macro2::TokenStream {
    todo!()
}

fn struct_array_codegen() -> proc_macro2::TokenStream {
    todo!()
}

fn trait_arrow_array_codegen() -> proc_macro2::TokenStream {
    todo!()
}

fn struct_builder_codegen() -> proc_macro2::TokenStream {
    todo!()
}