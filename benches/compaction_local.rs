...
use common::{
    ...
    ScenarioStorageTarget, ScenarioWorkload, StorageVolumeArtifact, SurfaceWorkloadState,
    SwmrReaderClass, SwmrReaderExpectationArtifact, SwmrWorkloadParams, SwmrWorkloadState,
    VersionSummary, WriteWorkloadState, artifact_path, benchmark_schema, build_artifact,
    build_run_id, build_runtime, cleanup_local_storage_volume, cleanup_object_store_storage_volume,
...
async fn prepare_surface_open_and_fresh_read(
    ...
    Ok(ScenarioState {
        ...
        storage_target: storage_target(storage, run_id, &benchmark_id)?,
        dimensions: ScenarioDimensionsArtifact::baseline(
            scenario_variant_id,
