...
use crate::{
    record::{DynRecord, DynRecordImmutableArrays, DynSchema, Record, Schema},
    ArrowArrays, ArrowArraysBuilder, Ts,
};
    ...
    I: IntoIterator<Item = (u32, DynRecord)>,
{
    ...
    let mut builder =
        DynRecordImmutableArrays::builder(schema.arrow_schema().clone(), rows_vec.len());
