...
use aisle::{
    ...
    reader::{
        ...
        predicate::AislePredicateFn,
    },
};
use arrow::{array::Datum, error::ArrowError};
use parquet::{
    arrow::{arrow_reader::ArrowPredicate, ProjectionMask},
...
pub(crate) unsafe fn get_aisle_range_filter<R>(
...
pub struct TonboPredicate {}

// impl AislePredicate for TonboPredicate {}
