...
mod inner {
    ...
    use crate::compaction::{executor::CompactionLease, planner::CompactionTask};
    ...
    impl CompactionScheduler {
        ...
        pub async fn enqueue(
            ...
            self.tx
                .send(ScheduledCompaction { task, lease })
                .await
    ...
    mod tests {
        ...
        async fn enqueue_and_drain_with_budget() {
            ...
            scheduler
                .enqueue(task.clone(), "worker-a", 1_000)
                .await
                .expect("enqueue");
            scheduler
                .enqueue(task.clone(), "worker-b", 1_000)
                .await
                .expect("enqueue");
